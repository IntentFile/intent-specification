...
overwriting the rest of its row, and that moving a source row between aggregate key-tuples repairs
both tuples. Version [1.0](1.0.md) remains unchanged. Nothing else is altered:
